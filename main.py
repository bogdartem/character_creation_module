...
# Глобальная константа. Стандартное значение атаки.
DEFAULT_ATTACK = 5
...
def special(char_name: str, char_class: str) -> str:
    ...
    if char_class == 'warrior':
        special_skill_value: int = 80 + 25
        return (f'{char_name} применил специальное умение'
                f' «Выносливость {special_skill_value}»')
    if char_class == 'mage':
        special_skill_value = 5 + 40
        return (f'{char_name} применил специальное умение'
                f' «Атака {special_skill_value}»')
    if char_class == 'healer':
        special_skill_value = 10 + 30
        return (f'{char_name} применил специальное умение'
                f' «Защита {special_skill_value}»')
